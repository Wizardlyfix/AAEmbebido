...
/* Includes ---------------------------------------------------------------- */
#include <HyperImpulse-project-1_inferencing.h>
#include <Wire.h>
#include "SparkFun_LIS2DH12.h"  //Click here to get the library: https://www.arduino.cc/reference/en/libraries/arduino_bmi270_bmm150/
